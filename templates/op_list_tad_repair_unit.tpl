    ...
    <table class="table table-striped table-hover">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
            <a href="unit.php?op=tad_repair_unit_form&unit_sn=<{$unit.unit_sn}>" class="btn btn-sm btn-xs btn-warning"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>  <{$smarty.const._TAD_EDIT}></a>
...
<div class="text-center">
    <a href="unit.php?op=tad_repair_unit_form" class="btn btn-info"><i class="fa fa-plus-square" aria-hidden="true"></i>  <{$smarty.const._TAD_ADD}></a>
</div>
