...
<{if $now_op=="list_tad_repair"}>
  ...
  <div class="row">
    <div class="col-sm-6">
      <form action="index.php" method="get" id="myForm" enctype="multipart/form-data" role="form">
    ...
    <div class="col-sm-6">
      <form action="excel.php" method="post" id="myForm" enctype="multipart/form-data" role="form">
        <div class="form-group row">
          <div class="col-sm-6">
